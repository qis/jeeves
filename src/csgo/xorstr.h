...
public:
  template <size_t... Is>
  constexpr __forceinline string(const char* str, std::index_sequence<Is...>) : key_(random_char<K>::value), encrypted_{ enc(str[Is])... } {}
...
#define xorstr(s) (xorstr_impl::string<sizeof(s) - 1, __COUNTER__>(s, std::make_index_sequence<sizeof(s) - 1>()).decrypt())